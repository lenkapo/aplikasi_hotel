  ...
  <form id="form_edit" enctype="multipart/form-data">
    ...
    <div class="form-group">
      ...
      <select name="is_active" class="form-control" required>
        <option value="" disabled <?= $r->is_active === null ? "selected" : "" ?>>Pilih Status</option>
        <option value="1" <?= $r->is_active == "1" ? "selected" : "" ?>>Tersedia</option>
        <option value="0" <?= $r->is_active == "0" ? "selected" : "" ?>>Tidak Tersedia</option>
      </select>
    </div>
