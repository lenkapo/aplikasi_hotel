	...
	">
                ...
                <div class="row">
                    ...
                    <div class="menu-bar">
                        <ul>
                            ...
                            <li class="<?= ($this->uri->segment(1) == 'restaurant') ? 'active' : '' ?>">
                                <a href="<?= base_url('restaurant') ?>">Restaurant</a>
                            </li>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="book-title">
                            <h2>Hotel Booking</h2>
                            <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Similique dolores minus molestias blanditiis neque dicta impedit repudiandae officiis voluptates vero, velit culpa, voluptate voluptatibus dolor officia quis quibusdam sit libero.</p>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="book-form inn-com-form">
                            ...
                            <form class="col s12" action="<?= base_url('beranda/submit') ?>" method="post">
                                <!-- Flash Message -->
                                ...
                                <div class="row">
                                    <div class="input-field col s6">
                                        <input type="text" id="from" name="arrival_date" required>
                                        <label for="from">Arrival Date</label>
                                    </div>
                                    <div class="input-field col s6">
                                        <input type="text" id="to" name="departure_date" required>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                M.Datepicker.init(document.querySelectorAll('#from, #to'), {
                    format: 'yyyy-mm-dd',
                    autoClose: true
                });
